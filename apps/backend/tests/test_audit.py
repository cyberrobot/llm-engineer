...
from assistant.infrastructure import audit
from infrastructure.database import connection as database
...
def test_init_db_adds_evaluation_column_if_missing():
    ...
    assert any(
        "ALTER TABLE audit_logs" in query and "ADD COLUMN IF NOT EXISTS evaluation" in query

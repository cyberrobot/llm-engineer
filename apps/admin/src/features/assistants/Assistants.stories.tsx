...
function Frame({api=base,path='/admin/assistants',children}:{api?:AdminApi;path?:string;children:ReactNode}){return <MemoryRouter initialEntries={[path]}><AuthProvider api={api} initialUser={{id:'admin',email:'admin@example.test',role:'administrator'}}>{children}</AuthProvider></MemoryRouter>}

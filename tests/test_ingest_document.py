...
class IngestDocumentTest(unittest.TestCase):
    def test_batches_embeddings_and_persists_chunks(self):
        text = ("a" * 500) + "b"
        ...
        with (
            ...
            patch(
                "api.services.ingest_document.save_document_with_chunks"
        ...
        self.assertEqual(result, {"doc_id": "doc-id", "chunks_created": 2})
